...
public class listdoctorcontroller extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ResultSet rsGetAllDoctor = daoDoc.GetAllDoctor();
        request.setAttribute("rsGetAllDoctor", rsGetAllDoctor);
        request.getRequestDispatcher("common/listdoctorhome.jsp").forward(request, response);
    }
