 ...
 * @author a
 */
@WebServlet(name = "ControllerDeactiveVaccine", urlPatterns = {"/ControllerDeactiveVaccine"})
public class DeactiveVaccineController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            daoVax.changeStatus(Integer.parseInt(VaccineID));
            daoVaxPac.changeStatus(Integer.parseInt(VaccineID));
