...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="admin/assets/img/logo3.png">
        ...
        <div class="header">
            <div class="header-left">
                <a href="index-2.html" class="logo">
                    <img src="admin/assets/img/logo4.png" width="35" height="35" alt=""> <span style="font-size: 30px">VACCINE</span>
                </a>
            </div>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="ControllerHomeAdmin"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
                        </li>
                        <li>
                            <a href="ControllerListDoctor"><i class="fa fa-user-md"></i> <span>Doctors</span></a>
                        </li>
                        <li>
                            <a href="ControllerListCustomer"><i class="fas fa-user-tie"></i> <span>Customers</span></a>
                        </li><!--
                        <li>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fa-solid fa-syringe"></i> <span>Vaccines Management</span> <span class="menu-arrow"></span></a>
                            <ul id="vaccinelist" style="display: none;">
                                <li><a id="vaccinelist-item" href="ControllerListVaccine">Vaccines</a></li>
                                <li><a id="vaccinelist-item" href="ControllerListVaccinePackage">Vaccine Packages</a></li>
                                <!--                                <li><a id="vaccinelist-item" href="holidays.html">Holidays</a></li>
                                                                <li><a id="vaccinelist-item" href="attendance.html">Attendance</a></li>-->
                            </ul>
                        </li>
                        <!--                        <li class="submenu">
