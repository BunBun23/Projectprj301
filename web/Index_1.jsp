<%-- 
    Document   : index
    Created on : 08-02-2022, 23:14:24
    Author     : a
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <link href="./admin_style/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    ***********************************-->
        ...
        ***********************************-->
        ...
        <script src="/admin_stylevendor/bootstrap-datetimepicker/js/moment.js"></script>
        <script src="/admin_stylevendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
        <!-- Chart piety plugin files -->
        <script src="./admin_style/vendor/peity/jquery.peity.min.js"></script>

        <!-- Apex Chart -->
        <script src="./admin_style/vendor/apexchart/apexchart.js"></script>

        <!-- Dashboard 1 -->
        <script src="./admin_style/js/dashboard/dashboard-1.js"></script>
        <script>
            $(function () {
