...
<html lang="en">
    ...
    <head>
        ...
        <!-- Favicon icon -->
        <link rel="icon" type="image/png" sizes="16x16" href="./admin_style/images/favicon.png">
        <link href="./admin_style/vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet">
        <link rel="stylesheet" href="./admin_style/vendor/chartist/css/chartist.min.css">
        <!-- Datatable -->
        <link href="./admin_style/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
        <link href="./admin_style/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
        <link href="./admin_style/css/style.css" rel="stylesheet">
...
<!--                    <img class="logo-abbr" src="./admin_style/images/logo.png" alt="">
                    <img class="logo-compact" src="./admin_style/images/logo-text.png" alt="">
                    <img class="brand-title" src="./admin_style/images/logo-text.png" alt="">-->
                <h1>FVAX</h1>
                </a>
                    ...
                    <ul class="metismenu" id="menu">
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li><a href="ControllerAdmin?action=VaccineManagePage">Vaccines Management</a></li>
            ...
            <div class="content-body">
                ...
                <div class="container-fluid">
                    <div class="form-head d-flex mb-sm-4 mb-3">
                        <div class="mr-auto">
                            <h2 class="text-black font-w600">Vaccine</h2>
                            <p class="mb-0">Vaccines Managements Fvax Clinic</p>
                        </div>
                        <div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="ControllerAdmin?action=addVaccine" method="POST">
                                        <div class="form-group">
                                            <input type="text" placeholder="Vaccine ID" name ="VaccineID" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" placeholder="Vaccine Name" name ="VaccineName" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" placeholder="Vaccine Price" name="VaccinePrice" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" placeholder="Vaccine Origin" name="VaccineOrigin" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" placeholder="Vaccine Detail" name="VaccineDetail" class="form-control">
                                        </div>
                                        <div class="form-group">
                                ...
                                <table id="example5" class="display dataTablesCard table-responsive-xl" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center">Vaccine Price</th>
                                    ...
                                    <tbody>
                                        ...
                                        %>
                                        <tr>
                                            <td style="text-align: center"><span class="text-nowrap"><%=rsVaccine.getString(1)%></span></td>
                                            <td style="text-align: center"><%=rsVaccine.getString(2)%></td>
                                            <td style="text-align: center"><%=rsVaccine.getString(3)%></td>
                                            <td style="text-align: center"><%=rsVaccine.getString(4)%></td>
                                            <td><%=rsVaccine.getString(5)%></a></td>
                                            <td>
                                                <div class="dropdown ml-auto text-right">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="ControllerAdmin?action=updateVaccine&VaccineID=<%=rsVaccine.getString(1)%>" data-toggle="modal" data-target="#editvaccine">Edit</a>
                                                        <a class="dropdown-item" href="ControllerAdmin?action=deleteVaccine&VaccineID=<%=rsVaccine.getString(1)%>">Delete</a>
                                                    </div>
                                                </div>
                                            </td>												
                                        </tr>
                    ...
                    <div class="modal fade" id="editvaccine">
                        <!--<form action="ControllerAdmin?action=updateVaccine" method="POST">-->
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        %>
                                        <div class="form-group">
                                            <input type="text" value="<%//=rsUpVaccine.getString(1)%>" name ="VaccineID" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" value="<%//=rsUpVaccine.getString(2)%>" name ="VaccineName" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" value="<%//=rsUpVaccine.getString(3)%>" name="VaccinePrice" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" value="<%//=rsUpVaccine.getString(4)%>" name="VaccineOrigin" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" value="<%//=rsUpVaccine.getString(5)%>" name="VaccineDetail" class="form-control">
                                        </div>
                                        <div class="form-group">
...
<!--                        </form>-->
            ...
            ***********************************-->
            <div class="footer">
                <div class="copyright">
                    <p>Copyright © Designed &amp; Developed by <a href="https://www.facebook.com/groups/613167039916875/" target="_blank">Fvax Team</a> 2022</p>
                </div>
            </div>
            <!--**********************************
                Footer end
    ...
    ***********************************-->
        ...
        ***********************************-->
        <!-- Required vendors -->
        <script src="./admin_style/vendor/global/global.min.js"></script>
        <script src="./admin_style/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
        <script src="./admin_style/vendor/chart.js/Chart.bundle.min.js"></script>
        <script src="./admin_style/js/custom.min.js"></script>
        <script src="./admin_style/js/deznav-init.js"></script>

        <!-- Datatable -->
        <script src="./admin_style/vendor/datatables/js/jquery.dataTables.min.js"></script>
        <script>
            (function ($) {
